...
import os
import time
from tqdm import tqdm  # tqdm==4.66.5
from openai import OpenAI # openai==1.52.0
...
os.environ['OPENAI_API_KEY'] = "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"  # Replace with your actual API key

#paths
DATA_DIR = Path("./H1 NMR Datasets/Challenges")
BENCHMARK_BASE = Path("./BENCHMARK")
BENCHMARKS_DIR = BENCHMARK_BASE / "GPT" / ""
